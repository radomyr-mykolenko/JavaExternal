...
/**
 * <p>Java class for flowersType complex type.
 * 
...
@XmlType(name = "flowersType", propOrder = {
    "flower"
})
public class FlowersType {

    protected List<FlowerType> flower;
     ...
     * 
     */
    public List<FlowerType> getFlower() {
        if (flower == null) {
            flower = new ArrayList<FlowerType>();
        }
        return this.flower;
    }
